...
public class PointCPTest
{
  ...
  private static void testPointCP3() {
        ...
        // Create a PointCP3 object
        PointCP point3 = new PointCP3(3, 4);
        System.out.println("Cartesian Point: " + point3);
        // Test conversion methods
        point3.convertStorageToPolar();
        System.out.println("Polar Point: " + point3);
        point3.convertStorageToCartesian();
        System.out.println("Back to Cartesian: " + point3);
        // Test getter methods
        System.out.println("X: " + point3.getX());
        System.out.println("Y: " + point3.getY());
        System.out.println("Rho: " + point3.getRho());
        System.out.println("Theta: " + point3.getTheta());
        // Test distance calculation
        System.out.println("Distance from origin: " + point3.getDistance(new PointCP3(0, 0)));
        // Test rotation
        System.out.println("Rotated point: " + point3.rotatePoint(90));
        System.out.println();
    }

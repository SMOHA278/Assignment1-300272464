...
public class PointCPTest
{
  ...
  public static void main(String[] args)
  {
   ...
   private static void testPointCP2() {
        ...
        // Create a PointCP2 object
        PointCP point2 = new PointCP2(3, 4);
        System.out.println("Cartesian Point: " + point2);
        // Test conversion methods
        point2.convertStorageToPolar();
        System.out.println("Polar Point: " + point2);
        point2.convertStorageToCartesian();
        System.out.println("Back to Cartesian: " + point2);
        // Test getter methods
        System.out.println("X: " + point2.getX());
        System.out.println("Y: " + point2.getY());
        System.out.println("Rho: " + point2.getRho());
        System.out.println("Theta: " + point2.getTheta());
        // Test distance calculation
        System.out.println("Distance from origin: " + point2.getDistance(new PointCP2(0, 0)));
        // Test rotation
        System.out.println("Rotated point: " + point2.rotatePoint(90));
        System.out.println();
    }
